 ...
 * @date 2017年2月7日
 */
@Repository("qqConnectUserDetailDAO")
public class QQConnectUserDetailDAO extends AbsConnectUserDetailDAO {
	
	private static final String TABLE_NAME = "qq_connect_user_detail";
