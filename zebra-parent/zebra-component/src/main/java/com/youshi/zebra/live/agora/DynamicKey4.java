...
//     */
//    public static String generatePublicSharingKey(String appID, String appCertificate, String channelName, 
//    		int unixTs, int randomInt, long uid, int expiredTs) throws Exception {
...
//     * @throws Exception if any error occurs
//     */
//    public static String generateRecordingKey(String appID, String appCertificate, String channelName, 
//    		int unixTs, int randomInt, long uid, int expiredTs) throws Exception {
...
//     * @throws Exception if any error occurs
//     */
//    public static String generateMediaChannelKey(String appID, String appCertificate, String channelName, 
//    		int unixTs, int randomInt, long uid, int expiredTs) throws Exception {
//        return doGenerate(appID, appCertificate, channelName, unixTs, randomInt, uid, expiredTs, MEDIA_CHANNEL_SERVICE);
//    }
//
//    private static String doGenerate(String appID, String appCertificate, String channelName, 
//    		int unixTs, int randomInt, long uid, int expiredTs, String serviceType) throws Exception {
//        String version = "004";
...
//        String signature = generateSignature4(appID, appCertificate, channelName, 
//        		unixTsStr, randomIntStr, uidStr, expiredTsStr, serviceType);
//        return String.format("%s%s%s%s%s%s", version, signature, appID, unixTsStr, randomIntStr, expiredTsStr);
//    }
//
//    private static String generateSignature4(String appID, String appCertificate, String channelName, 
//    		String unixTsStr, String randomIntStr, String uidStr, String expiredTsStr, String serviceType) throws Exception {
