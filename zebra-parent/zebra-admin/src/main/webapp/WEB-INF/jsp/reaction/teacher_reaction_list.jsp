			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 col-sm-7" style="left: 40px;">
						...
						<h5 class="group">反馈</h5>
						<div class="form-group">
							<label class="rea-label">课堂表现：</label>
							<span id="behavior-span">暂无</span>
						</div>
						<div class="form-group">
							<label class="rea-label">教学理念：</label>
							<span id="idea-span">暂无</span>
						</div>
...
$('.view-a').click(function() {
	...
	$.ajax({
		url: '/reaction/admin/details/byteacher',
		type: 'get',
		...
		success: function(result, status, xhr) {
			...
			if(meta.code == 1) {
				...
				$('#behavior-span').text(reac.behavior);
				$('#idea-span').text(reac.idea);
