...
<div class="row">
	<div class="col-xs-12">
		<div>
			<h3>说明</h3>
			<ul>
				<li>以天为单位，统计“新增用户数”和“新增付费用户数”。两者没有关联，后者可以是很久前注册的用户，在某天付了费</li>
				<li>当天数据，需要次日统计出来，如：2017-08-09日统计出2017-08-08的数据</li>
			</ul>
			<hr />
		</div>
		
		<span><h5><b>总用户数：${userCnt }，总付费用户数：${payUserCnt }</b></h5></span>
			...
			<div class="col-xs-12">
				...
				<div>
					<ul class="pagination" style="margin-top: 0px;">
						...
						<c:choose>
							<c:when test="${empty stats.nextCursor }">
								<li class="disabled">
							...
							<c:otherwise>
								<li class="">
									<a href="#${zweb:nextPage(stats) }" data-url="${zweb:nextPage(stats) }">
									下一页
									</a>
								</li>
							</c:otherwise>
