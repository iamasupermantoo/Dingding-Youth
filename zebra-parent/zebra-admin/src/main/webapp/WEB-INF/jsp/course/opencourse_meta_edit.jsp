...
<div class="row">
	...
	<div class="modal-dialog col-xs-12">
			<form id="modify-form" action="/opencourse/meta/admin/edit" method="post">
			<input type="hidden" id="cmId" name="cmId" value="${x.cmId}" />
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7">
						...
						<div class="form-group">
							...
							<div>
								<input id="name" name="name" class="input-large" type="text" value="${x.name}" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								...
								value="${x.price}" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<input id="teacher-hid" type="hidden" value="${x.teacherId}" />
							<div>
						...
						<div class="form-group">
							...
							<input id="type-hid" type="hidden" value="${x.type}" />
							<div>
						...
						<div class="form-group">
							...
							<div>
								...
								<textarea class="col-xs-10 limited" style="height: 100px" 
									id="desc" name="desc" maxlength="500">${x.desc}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<textarea class="col-xs-10 limited" style="height: 200px" 
									id="notes-textarea" name="subNotes" maxlength="500">${x.subNotes}</textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<input id="suitableCrowds-txt" name="suitableCrowds" class="input-large"
								value="${x.suitableCrowds}" type="text" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								...
								value="${x.joinCnt}" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<input id="openTime-txt" name="openTime" class="input-large date dateTime"
								value="${x.openTime}" type="text" />
							</div>
						</div>
...
showType();
function showType(){
	var type = $("#type-hid").val();
	$("#type-sel").val(type);
}


function showTeacher(){
	var teacher = $("#teacher-hid").val();
	$("#teacher").val(teacher);
}
