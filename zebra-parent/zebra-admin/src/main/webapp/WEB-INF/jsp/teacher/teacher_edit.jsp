...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form class="form-horizontal" id="add-form" role="form" action="/teacher/admin/edit" method="post">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="mobile-txt"><font color="red">* </font> 手机号: </label>

				<div class="col-sm-9">
					<input type="hidden" name="tid" value="${x.tid }"  />
					<input type="text" id="mobile-txt" name="mobile" class="col-xs-10 col-sm-5" value="${x.mobile }" readonly="readonly" />
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="password-pwd"> 密码: </label>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="name-txt" name="name" value="${x.name }" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="birthday" name="birthday" value="${x.birthday }" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="col-xs-10 col-sm-5 limited"   id="desc-textarea" name="desc" maxlength="50">${x.desc }</textarea>
				</div>
			</div>
