...
public class CalendarController {
	...
	@ApiOperation(value = "日历，获取小红点。返回数组：[1,3,5]代表当月1号，3号，5号有课，需要飘红点", tags=SwaggerTags.COURSE)
	@ApiImplicitParams({
	...
	public Object points(
		...
		Set<Integer> days = lessonService.getPoints(courseId, userId, UserType.Student, month);
	 ...
	 * 
	 */
	@ApiOperation(value = "日历，获取某天的课程提醒", tags=SwaggerTags.COURSE, response=CalendarLessonView.class)
	@ApiImplicitParams({
		@ApiImplicitParam(value = "z", name="z", required=true, dataType="String", paramType="query"),
		@ApiImplicitParam(value = "课程id", name="cid", dataType="String", paramType="query"),
	})
	...
	public Object reminders(
		...
		List<LessonModel > lessonList = lessonService.getDayLessons(courseId, userId, UserType.Student, day);
